<?php 
    ...
    //Recupera os generos
    $gen_id = $_GET['gen_id'];
    $gen_nome = $_GET['gen_nome'];

    //Seleciona as miniaturas por genero
    $q = "SELECT * FROM livros WHERE id_genero = '" . $gen_id . "' ORDER BY " . $ordenar ;
...
<div class="row">
    <div class="col-md-12">
        <img src="img/deco_<?=$gen_id;?>.jpg" width="1200px" class="img-fluid">
    </div>
</div>
...
<div class="col-md-4">
    <span class="h5 pull-right">
        ...
        <a href="generos.php?ordenar=preco DESC&gen_id=<?= $gen_id;?>&gen_nome=<?=$gen_nome; ?>">Maior preço</a>
        <?php } else{ ?>
        <a href="generos.php?ordenar=preco ASC&gen_id=<?= $gen_id;?>&gen_nome=<?=$gen_nome; ?>">Menor preço</a>
